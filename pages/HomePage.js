...
>>>>>>> 734d990508249de2bc1cee8aa8ac730a664bae15
            ...
            <Link
              href="RegisterForm"
              target="_blank"
              className="btn w-50 h-20 font-bold  text-xl place-self-center relative inline-flex text-white text-center items-center justify-start bg-black rounded hover:bg-white hover:text-black border-4 border-black-600 group pl-5 pr-5"
              replace
            >
              <p>Launch App</p>
            </Link>
